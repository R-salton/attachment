  ...
  if (!unitName && !isLoading) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-2xl font-black text-foreground uppercase">Registry Entry Not Found</h2>
        <p className="text-sm text-muted-foreground mb-6">The requested station code "{unitSlug}" is not recognized.</p>
    ...
    <div className="flex-1 bg-background pb-20 p-4 md:p-10">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-48 bg-card rounded-[3rem] border border-dashed border-border flex flex-col items-center gap-6 px-10 shadow-sm animate-in zoom-in-95 duration-500">
