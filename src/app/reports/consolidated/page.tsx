            ...
            <div className="flex flex-col lg:flex-row lg:items-end gap-6 md:gap-8 bg-slate-50 p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] border border-slate-100">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 w-full lg:w-auto">
                <Button 
                  ...
                  className="h-12 md:h-14 px-6 md:px-10 rounded-xl md:rounded-2xl font-black shadow-xl shadow-blue-600/20 bg-blue-600 hover:bg-blue-700 text-sm md:text-base transition-all active:scale-95"
                >
              ...
              <div className="space-y-12 md:space-y-16 animate-in fade-in slide-in-from-bottom-12 duration-1000">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-100 pb-8 md:pb-12">
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                      <Badge className="bg-blue-600 text-white border-none font-black text-[8px] md:text-xs uppercase px-2 md:px-4 py-1 rounded-lg shadow-lg shadow-blue-600/20">
                        Operational Span: {targetDaySpan} Days
                      </Badge>
                    </div>
                  </div>
                  <Button onClick={handleExport} className="rounded-xl md:rounded-2xl h-12 md:h-16 px-6 md:px-10 font-black bg-slate-900 hover:bg-slate-800 shadow-xl text-sm md:text-lg transition-all active:scale-95">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 md:gap-12">
                   <div className="lg:col-span-3 space-y-12 md:space-y-16">
                      <section className="bg-slate-50 p-6 md:p-16 rounded-[1.5rem] md:rounded-[3rem] border border-slate-100 shadow-inner relative overflow-hidden group">
                        ...
                        <h4 className="text-[10px] md:text-xs font-black text-blue-600 uppercase tracking-[0.5em] mb-6 md:mb-10 flex items-center gap-3">
                          <div className="w-4 md:w-8 h-[2px] bg-blue-600" /> Force Executive Narrative
                        </h4>
                        <div className="prose prose-slate prose-sm md:prose-xl max-w-none text-slate-800 leading-relaxed font-bold selection:bg-blue-100">
                          {result.executiveSummary}
                        </div>
                      </section>
                      ...
                      <section className="space-y-8 md:space-y-10 pt-8 md:pt-10 border-t border-slate-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                          <Card className="rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 bg-white border border-slate-100 shadow-xl">
                            <h5 className="text-[10px] md:text-xs font-black uppercase tracking-widest text-slate-400 mb-4 md:mb-6 flex items-center gap-2">
                              <ShieldCheck className="h-3.5 w-3.5 md:h-4 md:w-4" /> Unit Activity Share
                            </h5>
                          ...
                          <Card className="rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 bg-white border border-slate-100 shadow-xl">
                            <h5 className="text-[10px] md:text-xs font-black uppercase tracking-widest text-slate-400 mb-4 md:mb-6 flex items-center gap-2">
                              <BarChart3 className="h-3.5 w-3.5 md:h-4 md:w-4" /> Incident Frequency
                            </h5>
                            <div className="h-[250px] md:h-[300px] w-full">
                              <ResponsiveContainer width="100%" height="100%">
                   ...
                   <aside className="lg:col-span-1 space-y-6 md:space-y-8">
                      <Card className="rounded-[1.5rem] md:rounded-[2.5rem] border-none shadow-xl md:shadow-3xl overflow-hidden bg-emerald-50 ring-1 ring-emerald-100/50">
                        <CardHeader className="border-b border-emerald-100 p-6 md:p-8">
                          <CardTitle className="text-emerald-800 text-[10px] md:text-[11px] font-black uppercase tracking-[0.3em] flex items-center gap-2 md:gap-3">
                      ...
                      <Card className="rounded-[1.5rem] md:rounded-[2.5rem] border-none shadow-xl md:shadow-3xl overflow-hidden bg-blue-50 ring-1 ring-blue-100/50">
                        <CardHeader className="border-b border-blue-100 p-6 md:p-8">
                          <CardTitle className="text-blue-800 text-[10px] md:text-[11px] font-black uppercase tracking-[0.3em] flex items-center gap-2 md:gap-3">
                      ...
                      <Card className="rounded-[1.5rem] md:rounded-[2.5rem] border-none shadow-xl md:shadow-3xl overflow-hidden bg-red-50 ring-1 ring-red-100/50">
                        <CardHeader className="border-b border-red-100 p-6 md:p-8">
                          <CardTitle className="text-red-800 text-[10px] md:text-[11px] font-black uppercase tracking-[0.3em] flex items-center gap-2 md:gap-3">
                      ...
                      <Card className="rounded-[1.5rem] md:rounded-[2.5rem] border-none shadow-xl md:shadow-3xl overflow-hidden bg-amber-50 ring-1 ring-amber-100/50">
                        <CardHeader className="border-b border-amber-100 p-6 md:p-8">
                          <CardTitle className="text-amber-800 text-[10px] md:text-[11px] font-black uppercase tracking-[0.3em] flex items-center gap-2 md:gap-3">
                ...
                <div className="bg-slate-900 rounded-[2rem] md:rounded-[4rem] p-8 md:p-16 text-white flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 shadow-3xl relative overflow-hidden group">
                  <div className="absolute inset-0 bg-blue-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                  <div className="space-y-3 md:space-y-4 text-center lg:text-left relative z-10">
                    <div className="flex items-center justify-center lg:justify-start gap-2 md:gap-3">
                      ...
                      <h4 className="text-xl md:text-3xl font-black uppercase tracking-tight">Authorize Strategic Memo</h4>
                    </div>
                    <p className="text-slate-400 font-bold max-w-xl text-sm md:text-lg leading-relaxed">Archive this Overall Command Briefing into the official registry.</p>
                  </div>
                  <Button onClick={handleExport} size="lg" className="h-14 md:h-20 w-full lg:w-auto px-8 md:px-16 rounded-xl md:rounded-[2rem] font-black bg-blue-600 hover:bg-blue-700 shadow-2xl shadow-blue-600/40 text-sm md:text-xl transition-all active:scale-95 relative z-10">
                    <Download className="mr-3 md:mr-4 h-5 w-5 md:h-7 md:w-7" />
                    EXPORT OVERALL MEMO
                  </Button>
                </div>
              </div>
